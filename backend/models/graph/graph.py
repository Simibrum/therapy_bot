...
class Graph(object):
    ...
    As you get problems using ORM classes in the graph database, the graph uses
    pydantic models to store the graph in memory. This is then used to update the
    graph database.
    """
